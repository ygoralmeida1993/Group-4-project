...
import com.example.trip_plan_budget.activity.hotel.HotelPlannerActivity;
import com.example.trip_plan_budget.activity.restaurant.RestaurantPlannerActivity;
        ...
        binding.addPlan.setOnClickListener(v -> {
            ...
            switch (pos) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    startActivity(new Intent(HomeActivity.this, HotelPlannerActivity.class));
                    break;
                case 3:
                    startActivity(new Intent(HomeActivity.this, RestaurantPlannerActivity.class));
                    break;
            }
        });
